               ...
               <div class="search-bar">
                ...
                <table id="userTable">
                    ...
                    <tbody>
                        <tr>
                              <td>1</td>
                            <td>Aldrich Aditya Pramudya Putra</td>
                            <td>12-10-2025</td>
                            <td>Kelas</td>
                            <td>Kelas XII-RPL 2</td>
                            <td><span class="status menunggu">Menunggu</span></td>
                            <td style="text-align:center;">
                                <a href="{{ route('user.detailpengaduan') }}" class="aksi-eye" title="Lihat Detail">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                        ...
                        <tr>
                            <td>2</td>
                            <td>Berliana Cahya Rizky Wardani</td>
                            <td>12-10-2025</td>
                            <td>Koperasi</td>
                            <td>Kelas XII-RPL 2</td>
                        ...
                        <tr>
                            <td>3</td>
                            <td>Cendikiawan Rama Fahrezi Nugroho</td>
                            <td>12-10-2025</td>
                            <td>Toilet</td>
                            <td>Kelas XII-RPL 3</td>
                        ...
                        <tr>
                            ...
                            <td><span class="status selesai">Selesai</span></td>
                            <td style="text-align:center;">
                                <a href="/detailpengaduan2/1" class="aksi-eye" title="Lihat Detail">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        <path d="M1.5 12s4-7 10.5-7 10.5 7 10.5 7-4 7-10.5 7S1.5 12 1.5 12z"
                                            stroke="#0059FF" stroke-width="2.8"/>
                                        <circle cx="12" cy="12" r="3"
